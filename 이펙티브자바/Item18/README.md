...
**래퍼클래스 :** 다른 인스턴스를 감싸고 있다 

`InstrumentedSet` : **데코레이터 패턴**
...
위에 해당하는 self문제를 제외하고는 단점이 거의 없다
...
**자바 라이브러리 중에서도 위반한 사례가 존재한다.**

**java의 stack은 vector아 아니므로 확장해서는 안됐다.** 

강의속 여담으로 제임스 고슬링또한 본인이 만든 상속이 이상하게 쓰이는것을 경고한적이 있다.

자바 버전이 올라가며 나온 Default 제어자가 영향을 받지않았을까?
